...
Section text here.
\par
cloudlet really needed?
\par
previous worth architectural changes?
\par
mobile cloud still useful to harness unused resources
\par
battery drain viable reason to close connections
\par
roaming costs valid option
\par
disaster scenario viable
\par
flexible computing could solve previous. cloud ran and quickly transporting radio heads to site?
\par
dont have so much worry security when trusted open cloud
\par
mobility challenges exist in cran but not as big as with mobile cloud
