...
\par
mobile cloud computing and its different types introduction
\par
introduce future networks
\par
how does these two interact
\par
two technologies being developed, it should at least be checked what kind of relationship they have
\par
overview of both fields and my views on their interaction
\end{abstract}
...
iot coming
\par
analyzing ever growing mobile data needs new approaches cause its so big
\par
new ways to use this data could be invented
\par
introduce different ways to handle computational load of future (mcc tyypes)
\par
next generation mobile network technologies
\par
how is it improveing
\par
should 5g consider mcc or mcc consider 5g
\par
do they have overlapping goals/features?
...
\par
mobile cloud computing not as necessary imo
\par
wide iot only exists in future, when 5g should already be in place
\par
bad to look into it from lte point of view
\par
more accurate research should be done of mcc in context of future networks
\par
i think they have similar goals and 5g is coming anyway
\par
maybe mcc should try to solve just what 5g cant?
\par
implementing applications in different points of ran offers great possibilities in terms of mobile data analysis and should be looked into closely
